...
import { Shield, Zap, CloudLightning, CheckCircle, LocateFixed, Radar, WalletCards } from 'lucide-react';
...
export default function Landing() {
  ...
  return (
    ...
    >
      ...
      <footer className="mt-8 md:mt-16 border-t border-white/5 py-6 md:py-8">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <Shield className="h-4 w-4 text-cyan-300" />
            <span className="text-xs md:text-sm font-semibold text-slate-200">ClaimSure</span>
          </div>
          <p className="text-[10px] md:text-xs text-slate-400">Parametric Insurance Platform · Demo</p>
        </div>
      </footer>
    </motion.div>
  );
